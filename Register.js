...
const Register = ({ setIsAuthenticated }) => {
    ...
    const handleChange = (e) => {
        ...
        } else if (name === 'isAdminRequest') {
            setIsAdminRequest(e.target.checked);
        } else {
            switch (name) {
                case 'userId':
                    setUserId(value);
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('isAdminRequest', isAdminRequest);
        if (image) {
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            ...
            window.location.href = '/'; // Redirect to login after verification
        } catch (error) {
